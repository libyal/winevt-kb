...
$Dependencies = "PyYAML cffi cryptography dfdatetime dfvfs dfwinreg dtfabric idna libbde libcreg libevt libevtx libewf libexe libfsapfs libfsext libfshfs libfsntfs libfsxfs libfvde libfwevt libfwnt libluksde libmodi libqcow libregf libsigscan libsmdev libsmraw libvhdi libvmdk libvsgpt libvshadow libvslvm libwrc mock pbr pytsk3 six xattr"
