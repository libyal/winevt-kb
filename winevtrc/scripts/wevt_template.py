...
def Main():
    ...
    if exe_section:
        ...
        wevt_template_wrc_resource = wrc_stream.get_resource_by_name("WEVT_TEMPLATE")
                            ...
                            if wevt_provider.number_of_events > 0:
                                ...
                                for wevt_event in wevt_provider.events:
                                    ...
                                    if wevt_event.template_offset > 0:
                                        wevt_template = (
                                            wevt_provider.get_template_by_offset(
            ...
            if message_table_wrc_resource:
                ...
                for wrc_resource_sub_item in wrc_resource_item.sub_items:
                    ...
                    for message_index in range(number_of_messages):
                        message_identifier = (
                            message_table_resource.get_message_identifier(message_index)
                        )
