...
class SQLite3OutputWriter:
    ...
    def _WriteMessageIdentifierMappings(self, template_resource_file, database_writer):
            ...
            for wevt_provider in iter(wevt_manifest.providers):
                ...
                for wevt_event in wevt_provider.events:
                    if wevt_event.message_identifier != 0xFFFFFFFF:
                        attribute_container = (
                            resources.WinevtResourcesMessageStringMapping(
    ...
    def Open(self):
        ...
        self._database_writer.Open(path=event_providers_database_path, read_only=False)
                    ...
                    for message_filename in event_log_provider.event_message_files:
                        ...
                        if message_resource_file:
                            ...
                            template_resource_file = (
                                extractor_object.GetTemplateResourceFile(
                                    message_filename
                                )
                            )
