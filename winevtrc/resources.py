...
class WinevtResourcesMessageFileDatabase(containers_interface.AttributeContainer):
    ...
    SCHEMA = {"database_filename": "str", "windows_path": "str"}
...
containers_manager.AttributeContainersManager.RegisterAttributeContainers(
    [
        ...
        WinevtResourcesMessageFileDatabase,
