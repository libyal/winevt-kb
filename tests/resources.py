...
class WinevtResourcesEventLogProviderTest(test_lib.BaseTestCase):
    ...
    def testSetCategoryMessageFilenames(self):
        ...
        event_log_provider.SetCategoryMessageFilenames(expected_category_message_files)
        self.assertEqual(
            event_log_provider.category_message_files, expected_category_message_files
        )
    ...
    def testSetEventMessageFilenames(self):
        ...
        event_log_provider.SetEventMessageFilenames(expected_event_message_files)
        self.assertEqual(
            event_log_provider.event_message_files, expected_event_message_files
        )
    ...
    def testSetParameterMessageFilenames(self):
        ...
        self.assertEqual(
            event_log_provider.parameter_message_files, expected_parameter_message_files
        )
